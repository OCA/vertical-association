...
class TestMembership(TestMembershipCommon):
    def test_none_membership(self):
        self.membership_1.write(
            {
                "membership_date_from": fields.Date.context_today(self.env.user)
                + relativedelta(years=-2),
                "membership_date_to": fields.Date.context_today(self.env.user)
    ...
    def test_old_membership(self):
        ...
        self.partner_2.write(
            {"free_member": False, "associate_member_id": self.partner_1.id}
        )
        self.assertEqual(
            self.partner_2.membership_state,
            "old",
